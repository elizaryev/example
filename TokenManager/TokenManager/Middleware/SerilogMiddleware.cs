...
namespace TokenManager.Middleware
{
    class SerilogMiddleware
    {
        const string MessageTokenManager = "HTTP {RequestMethod} {RequestPath} responded {StatusCode} in {Elapsed:0.0000} ms \nRequest parameters:{requestParameters:}\nException is:";
        ...
        public async Task Invoke(HttpContext httpContext)
        {
            ...
            try
            {
                ...
                log.Write(level, MessageTokenManager, httpContext.Request.Method, httpContext.Request.Path, statusCode, sw.Elapsed.TotalMilliseconds);
            }
        ...
        static bool LogException(HttpContext httpContext, Stopwatch sw, Exception ex)
        {
            ...
            LogForErrorContext(httpContext)
                .Error(ex, MessageTokenManager, httpContext.Request.Method, httpContext.Request.Path, 500,
