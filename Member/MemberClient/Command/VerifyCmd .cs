...
{
    public class VerifyCmd : ICommand<bool>
    {
        private readonly IReceiver<ICommandParameters, ICmdResult> _receiver;
        private readonly ICommandParameters _parameters;

        public VerifyCmd(IReceiver<ICommandParameters, ICmdResult> receiver, ICommandParameters parameters)
        {
            _receiver = receiver;
        ...
        {
            var cmdResult = (CmdResult<bool>) await _receiver.Action(ActionType.Verify, _parameters);
