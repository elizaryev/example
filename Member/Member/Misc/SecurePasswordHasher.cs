...
namespace Member.Misc
{
    ...
    public class SecurePasswordHasher: ISecurePasswordHasher
    {
      // These constants may be changed without breaking existing hashes.
        private int SALT_BYTES = 24;
        private int HASH_BYTES = 18;
        private int PBKDF2_ITERATIONS = 100000; // Bringing this code in 2016 today, 100 000 iterations is a rather good number for server-side hashing
        ...
        public SecurePasswordHasher(IOptions<MemberServiceSettings> memberServiceSettings)
        {
            SALT_BYTES = memberServiceSettings.Value.SaltSize;
            HASH_BYTES = memberServiceSettings.Value.HashSize;
            PBKDF2_ITERATIONS = memberServiceSettings.Value.Iterations;
        }
        ...
        public bool Verify(string password, string hashedPassword)
        {
            ...
            if (split[HASH_ALGORITHM_INDEX] != "aes-256-gcm")
            {
                throw new CannotPerformOperationException(
